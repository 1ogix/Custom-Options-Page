...
// Register the custom group for Elementor
...
// Register the dynamic tags for both fields (mobile and email)
function register_custom_dynamic_tags( $dynamic_tags_manager ) {
    if ( class_exists( '\Elementor\Core\DynamicTags\Tag' ) ) {
        // Correct path to your dynamic tag file based on the new structure
        require_once plugin_dir_path( __FILE__ ) . 'dynamic-tags/custom-dynamic-tag.php';
...
add_action( 'elementor/dynamic_tags/register', 'register_custom_dynamic_tags' );
